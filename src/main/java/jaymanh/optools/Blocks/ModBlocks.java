...
public class ModBlocks {
    public static final DeferredBlock<Block> DIAMONDIUM_BLOCK = OpTools.BLOCKS.register("diamondium_block",
            () -> new Block(BlockBehaviour.Properties.of().sound(SoundType.NETHERITE_BLOCK).destroyTime(4f).requiresCorrectToolForDrops()));
    ...
    public static final DeferredBlock<Block> DIAMONDILLIUM_BLOCK = OpTools.BLOCKS.register("diamondillium_block",
            () -> new Block(BlockBehaviour.Properties.of().sound(SoundType.NETHERITE_BLOCK).destroyTime(5f).requiresCorrectToolForDrops()));
    ...
    public static final DeferredBlock<Block> STONE_DARKMATTER_ORE = OpTools.BLOCKS.register("stone_darkmatter_ore",
            () -> new Block(BlockBehaviour.Properties.of().sound(SoundType.STONE).destroyTime(1f).requiresCorrectToolForDrops()));
    ...
    public static final DeferredBlock<Block> DEEPSLATE_DARKMATTER_ORE = OpTools.BLOCKS.register("deepslate_darkmatter_ore",
            () -> new Block(BlockBehaviour.Properties.of().sound(SoundType.DEEPSLATE).destroyTime(1.5f).requiresCorrectToolForDrops()));
    ...
    public static final DeferredBlock<RefineryBlock> REFINERY = OpTools.BLOCKS.register("refinery",
            () -> new RefineryBlock(BlockBehaviour.Properties.of().sound(SoundType.METAL).destroyTime(0.5f)));
